...
public class ProviderScrubTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        log.info("provider_scrub_01_health_plan_provider_id complete");
        jdbcTemplate.execute("SELECT provider_scrub_02_missing_network_code()");
        log.info("provider_scrub_02_missing_network_code complete");
        ...
        log.info("provider_scrub_05_missing_taxonomy_specialty complete");
        jdbcTemplate.execute("SELECT provider_scrub_06_bad_network_code()");
        log.info("provider_scrub_06_bad_network_code complete");
        jdbcTemplate.execute("SELECT provider_scrub_07_mismatched_taxonomy_specialty()");
        log.info("provider_scrub_07_mismatched_taxonomy_specialty complete");
        ...
        log.info("provider_scrub_16_missing_health_plan_provider_address_id complete");
        try {
            Thread.sleep(1000);
        } catch (Exception e) {
        ...
        log.info("provider_scrub_25_invalid_city_state_zip_county complete");
        try {
            Thread.sleep(1000);
        } catch (Exception e) {
            log.info("Sleep failed.");
        ...
        log.info("provider_scrub_54_invalid_city_state_zip complete");
        try {
            Thread.sleep(1000);
        } catch (Exception e) {
            log.info("Sleep failed.");
        ...
        // jdbcTemplate.execute("SELECT provider_scrub_59_invalid_usps_zip_code()");
        // jdbcTemplate.execute("SELECT provider_scrub_60_missing_par_record_status()");
        // jdbcTemplate.execute("SELECT provider_scrub_61_missing_non_par_record_status()");
        // jdbcTemplate.execute("SELECT provider_scrub_62_invalid_par_record_status()");
        // jdbcTemplate.execute("SELECT provider_scrub_63_invalid_non_par_record_status()");
        // jdbcTemplate.execute("SELECT provider_scrub_64_missing_panel_status()");
        // jdbcTemplate.execute("SELECT provider_scrub_65_invalid_panel_status()");

        /* Post Scrub Routines */
        jdbcTemplate.execute("SELECT provider_scrub_998_post_scrub()");
        log.info("provider_scrub_998_post_scrub complete");
        try {
            Thread.sleep(1000);
        } catch (Exception e) {
            log.info("Sleep failed.");
        ...
        log.info("provider_scrub_999_flag_error_records complete");
        try {
            Thread.sleep(1000);
        } catch (Exception e) {
            log.info("Sleep failed.");
